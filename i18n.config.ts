export default defineI18nConfig(() => ({
  ...
  messages: {
    en: {
      ...
      developer:
        "For over five years, I’ve been helping founders and business owners build the technology that drives their organizations. My expertise lies in developing ERP systems, SaaS platforms, and IoT solutions, with a focus on understanding and addressing complex, industry-specific requirements",
      computer:
        "With a computer science background, I enjoy working through challenging problems and finding solutions that fit. As a full-stack developer, I handle every step of the process—from concept to deployment—ensuring your vision becomes a reality.",
      founder:
        "Whether you’re a non-technical founder or an established company, I’m here to help. Let’s chat—feel free to send me an email!",
      technologies: "Technologies I use",
      whywithme: "Why work with me ?",
      background:
        "I'm not just a developer—I’m a problem solver. I thrive on turning big, bold ideas into reality, no matter how complex or ambitious they might seem. Whether it's building from scratch or optimizing systems that are already in place, I can break things down and find the smartest way to get it done.",
      independently:
        "With years of experience working independently, I'm fast, flexible, and know how to deliver high-quality work under pressure. I've developed internationally publicized projects, so I get the critical need for reliability, performance, and hitting deadlines.",
      softskill:
        "Most importantly, I believe in clear communication. I won’t bog you down with technical details unless you want them—you need results, and that’s exactly what I deliver.",
      chat: "Let's chat",
