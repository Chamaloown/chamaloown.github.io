...
const classes: Record<string, Record<string, boolean>> = {
  ...
  togglebuttons__input: {
    ...
    "group-data-[vertical=false]/options:group-first/option:!rounded-none":
      true,
    ...
    "group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-neutral-100":
      true,
    "group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-neutral-900":
      true,
    "group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-neutral-900":
      true,
    "dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-neutral-900":
      true,
    "dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-neutral-100":
      true,
    "dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-neutral-100":
      true,
    ...
    "group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-neutral-100":
      true,
    "group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-neutral-900":
      true,
    "group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-neutral-900":
      true,
    "dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-neutral-900":
      true,
    "dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-neutral-100":
      true,
    "dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-neutral-100":
      true,
  },
  transferlist__outer: {
    group: true,
  ...
  "multi-step__tab": {
    ...
    "dark:group-data-[tab-style=progress]/wrapper:before:border-neutral-700":
      true,
    ...
    "group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-neutral-900":
      true,
    ...
    "dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-neutral-300":
      true,
  },
